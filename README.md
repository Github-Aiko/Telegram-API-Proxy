...
```
https://aiko-api-proxy.pages.dev/api/bot
```
...
var url = 'https://aiko-api-proxy.pages.dev/api/bot' + botToken + 
...
def send_telegram_message(message):
    ...
    url = f"https://aiko-api-proxy.pages.dev/api/bot{token}/sendMessage"
...
[https://aiko-api-proxy.pages.dev/](https://aiko-api-proxy.pages.dev/)
